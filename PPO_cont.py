...
class PPO(object):
	...
	def save(self,EnvName, timestep):
		torch.save(self.actor.state_dict(), "./checkpoints/{}_actor{}.pth".format(EnvName,timestep))
		torch.save(self.critic.state_dict(), "./checkpoints/{}_q_critic{}.pth".format(EnvName,timestep))

	def load(self,EnvName, timestep):
		self.actor.load_state_dict(torch.load("./checkpoints/{}_actor{}.pth".format(EnvName, timestep)))
		self.critic.load_state_dict(torch.load("./checkpoints/{}_q_critic{}.pth".format(EnvName, timestep)))
